...
class MortgageViewController: UIViewController, UITextFieldDelegate {
    ...
    @objc func appMovedToBackground() {
        ...
        defaults.set(principleAmountTF.text, forKey: "mortgagePrincipleAmount")
        defaults.set(monthlyPaymentTF.text, forKey: "mortgageMonthlyPayment")
        defaults.set(numberOfPaymentsTF.text, forKey: "mortgageNumberOfPayments")
        defaults.set(interestRateTF.text, forKey: "mortgageInterestRate")
    }
    
    func readTextField() {
        principleAmountTF.text = defaults.string(forKey: "mortgagePrincipleAmount")
        monthlyPaymentTF.text = defaults.string(forKey: "mortgageMonthlyPayment")
        numberOfPaymentsTF.text = defaults.string(forKey: "mortgageNumberOfPayments")
    ...
    @IBAction func calculateButtonPressed(_ sender: UIButton) {
        ...
        let validationError = validateInput(principleAmount: principleAmount, monthlyPayment: monthlyPayment, interestRate: interestRate, numberOfPayments: numberOfPayments)
        
        switch finding {
        case .PrincipleAmount:
            let result = Mortgage.initialValue(monthlyPayment: monthlyPayment!, interestRate: interestRate!, numberOfPayments: numberOfPayments!)
        ...
        case .MonthlyPayment:
            let result = Mortgage.monthlyPayment(principleAmount: principleAmount!, interestRate: interestRate!, numberOfPayments: numberOfPayments!)
    ...
    // This method adds symbols to the text fields
